...
local Window = Luna:CreateWindow({
	Name = "Ro-Breaker : 99 Nights In Forest", 
	Subtitle = ".gg/DMNXkC6CYB", 
	LogoID = "128651960765653",
	LoadingEnabled = true, 
	LoadingTitle = "Ro-Breaker Serve Your Services",
	LoadingSubtitle = "by Ro-breaker", 

	ConfigSettings = {
		RootFolder = nil, 
		ConfigFolder = "Ro-Breaker 99 NIF"
	},
...
-- Info section
InfoTab:AddLabel("Hello")
InfoTab:AddParagraph("I'm Black Weed. I like to provide people cheats for free. F*** paid cheats.")
...
-- Specific item collection buttons
BringTab:AddButton({
    Name = "Bring Logs",
    Callback = function()
